...
> **Важливо:**
> Спершу збирайте бінарники на вашій машині
> Потім переносьте їх на цільовий ARM пристрій.

> /scripts/build-native.sh - збірка бінарників

> /scripts/deploy-native.sh - тільки розгортання готових бінарників
